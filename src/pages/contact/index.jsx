...
import { ToasterContainer } from "../../global/toaster/toaster";
...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceId = 'service_v4egsta';
    const templateId = 'template_et5zv1e';
    const publicKey = 'OrlMrKno-i_uL3BU1';
    ...
    const data = {
      ...
      template_params: {
        from_name: name,
        from_email: email,
        to_name: 'African Grand Expeditions',
        phone: phone,
        message: message,
      }
    };
    ...
    try {
      ...
      if(res.data){
        SuccessToast("Email Has been send successfully");
      }
    } catch (error) {
      console.error(error);
    }
  ...
  return (
    <Layout title="Contact Us">
      <section className="relative z-10 overflow-hidden bg-white py-20 lg:px-16 lg:py-[120px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-body-color mb-9 text-base leading-relaxed">
                 Feel free to use the provided contact details to
                  connect with us via phone, email, or even visit our office in
                  person. Our knowledgeable staff is committed to providing
                  exceptional customer service and ensuring your inquiries are
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-black/60 text-base">
                      Kogo Star Plaza, Nairobi West, Kenya
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-black/60 text-base">
                      safaris@africangrandexpeditions.com
                    </p>
                  </div>
                </div>
              </div>
